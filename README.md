...
- Mathematics for climate & sustainability

#### 🛠️ Skills
- Python (NumPy, Pandas)
- Machine learning (PyTorch, TensorFlow, Scikit-learn)
- Data engineering & pipelines
- Geospatial tools (GeoPandas, Shapely, PyGMT)
- Scientific visualisation (Matplotlib, Seaborn, Plotly)
- Scientific writing & communication

#### 🌱 Currently learning
- Urban science, planning & transport
- Earth observation
- Open data

<!--
**foteinidd/foteinidd** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
